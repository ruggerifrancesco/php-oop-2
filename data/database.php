<?php
    ...
    $productsList = [
        ...
        new Food('Cat Food', 'Premium Cat Food', 'Healthy and nutritious cat food', 17.99, 'Rich in vitamins', $catsCategory),
        new Food('Dog Food', 'Premium Dog Food', 'Healthy and nutritious dog food', 19.99, 'High in protein', $dogsCategory)
    ]
?>
